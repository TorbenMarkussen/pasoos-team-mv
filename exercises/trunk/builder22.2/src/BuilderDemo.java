...
public class BuilderDemo {
    public static void main(String[] args) {
        ...
        WordCounterBuilder wordCounterBuilder;
        wordCounterBuilder = new WordCounterBuilder();
        wp.construct(wordCounterBuilder);
        System.out.println("--- Counting words ---");
        System.out.println("Word count : " + wordCounterBuilder.getWordCount());
