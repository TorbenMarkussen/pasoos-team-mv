...
public interface PayStation  {
     ...
     * 
     * @param coinValue
     *            is an integer value representing the coin in cent. That is, a quarter is coinValue=25, etc.
     * @throws IllegalCoinException
     *             in case coinValue is not a valid coin value
     */
    public void addPayment(int coinValue) throws IllegalCoinException;

    /**
     * Read the machine's display. The display shows a numerical description of the amount of parking time accumulated so far based on
     * inserted payment.
     * 
