    ...
    <xsl:template name="metrics-reference.html">
        <html>
            ...
            <body style="text-align:justify;">
                ...
                <p/>
                A class that is deep within the tree inherits more methods and stateId
                ...
                The number of distinct stateId variables in a class serves as one measure of
                its complexity. The more stateId a class represents the more difficult it is to
                maintain invariants for it. It also hinders comprehensibility and reuse.
                <p/>
                In Java, stateId can be exposed to subclasses through protected fields, which
                ...
                and hidden dependencies between the stateId variables.
                <p/>
                ...
                each other. It is determined by examining the pattern of stateId variable
                accesses within the set of methods. If all the methods access the same stateId
                ...
                would be if none of the methods accessed any of the stateId variables.
