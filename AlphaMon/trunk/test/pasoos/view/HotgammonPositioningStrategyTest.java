...
public class HotgammonPositioningStrategyTest {
    ...
    private HotgammonPositioningStrategy positioningStrategy;

    @Before
    public void setUp() throws Exception {
        positioningStrategy = new HotgammonPositioningStrategy();
    }
    ...
    public void should_position_6_checkers_on_a_straight_row() {
        ...
        Point checker1Position = positioningStrategy.calculateFigureCoordinatesIndexedForLocation(Location.R1, 0); // Calculate Checker 1 position
        assertTrue(r.contains(checker1Position));

        // Check Checker position 2
        Point checker2Position = positioningStrategy.calculateFigureCoordinatesIndexedForLocation(Location.R1, 1); // Calculate Checker 2 position
        ...
        Point checker6Position = positioningStrategy.calculateFigureCoordinatesIndexedForLocation(Location.R1, 5); // Calculate Checker 6 position
    ...
    public void should_position_7th_checker_between_checker_1_and_2() {
        ...
        Point checker7Position = positioningStrategy.calculateFigureCoordinatesIndexedForLocation(Location.R1, 6); // Calculate Checker 7 position
    ...
    public void should_position_12th_checker_as_checker_2_() {
        Point checker2Position = positioningStrategy.calculateFigureCoordinatesIndexedForLocation(Location.R8, 1); // Calculate Checker 2 position
        Point checker12Position = positioningStrategy.calculateFigureCoordinatesIndexedForLocation(Location.R8, 11); // Calculate Checker 12 position
